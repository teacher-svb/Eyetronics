...
public class objReaderCSharpV5 : MonoBehaviour {
...
//		Debug.Log(_triangleArray.Length);
	...
	public void CleanupFile() {
		//~ ArrayList tempVertexArrayList = _vertexArrayList;
		//~ ArrayList temp = _vertexArrayList;
		//~ foreach (Vector3 item in _vertexArrayList) {
			//~ foreach (Vector3 item2 in tempVertexArrayList) {
				//~ if (item == item2) {
				//~ }
			//~ }
		//~ }
