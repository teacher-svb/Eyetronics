...
public class GUIScriptCSharpV2 : MonoBehaviour {
	...
	public enum menuStates { MS_start, MS_levelSelection, MS_pause, MS_end };
	...
	void OnGUI () {
		//~ GUI.Label(new Rect(10,10,300,100), GameObject.Find("GameCamera").GetComponent<UserManager>().userUrl);
		GUI.skin = myskin;
	...
	public void OnPause () {
		...
		switch (_menuState) {
			...
			case menuStates.MS_levelSelection:
				...
				GUI.DrawTexture(new Rect((int)(Screen.width/2) - (relativePosition * 35.0f), Screen.height - (int)(relativePosition*160.0f), (int)(relativePosition * 104.0f),  (int)(relativePosition * 70.0f)), arrowNext);
				if (GUI.Button(new Rect((int)(Screen.width/2) - (relativePosition * 35.0f), Screen.height - (int)(relativePosition*160.0f), (int)(relativePosition * 104.0f),  (int)(relativePosition * 70.0f)), "next")) {
			...
			case menuStates.MS_pause: 
				GUI.DrawTexture(new Rect((int)(Screen.width/2) - (relativePosition * 35.0f), Screen.height - (int)(relativePosition*160.0f), (int)(relativePosition * 104.0f),  (int)(relativePosition * 70.0f)), arrowNext);
				if (GUI.Button(new Rect((int)(Screen.width/2) - (relativePosition * 35.0f), Screen.height - (int)(relativePosition*160.0f), (int)(relativePosition * 104.0f),  (int)(relativePosition * 70.0f)), "Play"))
					this.gameObject.GetComponent<GameManagerCSharpV1>().GoToPlay();
				break;
			case menuStates.MS_end:
				GUI.DrawTexture(new Rect((int)(Screen.width/2) - (relativePosition * 35.0f), Screen.height - (int)(relativePosition*160.0f), (int)(relativePosition * 104.0f),  (int)(relativePosition * 70.0f)), arrowNext);
				GUI.TextField(new Rect(Screen.width/2 - 250, (int)(relativePosition *30.0f),500,200), "Congratulations\n" + "You've got\n" + GameObject.Find("scorekeeper").GetComponent<ScoreBoxScriptCSharpV1>()._score + "\npoints");
				if (GUI.Button(new Rect((int)(Screen.width/2) - (relativePosition * 35.0f), Screen.height - (int)(relativePosition*160.0f), (int)(relativePosition * 104.0f),  (int)(relativePosition * 70.0f)), "menu"))
					_menuState = menuStates.MS_levelSelection;
				break;
			default: break;
		}
	}
